...
const ProductInteraction = ({
  ...
  return (
    <div className="flex flex-col gap-4 mt-4">
      ...
      <div className="flex flex-col gap-2 text-xs">
        ...
        <div className="flex items-center gap-2">
          {product.sizes.map((size) => (
            <div
              className={`cursor-pointer border-black-1 p-[2px] ${selectedSize === size ? "border-gray-600" : "border-gray-300"}`}
      ...
      <div className="flex flex-col gap-2 text-sm">
        ...
        <div className="flex items-center gap-2">
          {product.colors.map((color) => (
            <div
              className={`cursor-pointer border-black-1 p-[2px] ${selectedColor === color ? "border-gray-300" : "border-white"}`}
      ...
      <button className="ring-1 ring-gray-400 shadow-lg text-gray-800 px-4 py-2 rounded-md flex items-center justify-center gap-2 text-sm font-medium">
