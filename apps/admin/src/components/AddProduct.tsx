          ...
          <SheetDescription asChild>
            <Form {...form}>
              <form className="space-y-8" onSubmit={form.handleSubmit(data=>mutation.mutate(data))}>
                      ...
                      <div className="">
                        {
                          form.watch("colors")?.map((color)=>(
                            <div className="mb-4 flex items-center gap-4" key={color}>
                              ...
                              />
                              {field?.value?.[color]? (<span className="text-green-600 text-sm">Image Selected</span>):(<span className="text-red-600 text-sm">No Image Selected</span>)}
                            </div>
                          ))
                        }
                      </div>
                ...
                <Button type="submit" disabled={mutation.isPending} className="disabled:opacity-50 disabled:cursor-not-allowed">Submit</Button>
              </form>
            </Form>
          </SheetDescription>
        </SheetHeader>
